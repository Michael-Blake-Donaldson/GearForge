  ...
  (spec) =>
    spec.items.map((name, index) => {
      ...
      return {
        ...
        description: `${name} is a core ${spec.category.toLowerCase()} topic in automotive diagnostics, maintenance, and system-level understanding.`,
        function: `Technicians use ${name} knowledge to evaluate behavior, isolate failure causes, and confirm durable repairs through repeatable tests.`,
        keyFacts: [
