...
export const lessons: Lesson[] = [
  {
    ...
    keyTakeaway: 'Valvetrain layout is a packaging and control strategy decision, not just a power decision.',
    quizId: 'am-q1',
    order: 1,
    xpReward: 30,
  },
  {
    ...
    shortExplanation: 'Understand transfer cases, driveshafts, and axle behavior.',
    content:
    ...
    keyTakeaway: '4WD systems add controlled torque routing, not just extra driven wheels.',
    quizId: 'am-q2',
    order: 2,
    xpReward: 30,
  },
  {
    ...
    shortExplanation: 'How springs and dampers are tuned for payload and stability.',
    content:
    ...
    keyTakeaway: 'Suspension tuning is a compromise between comfort, control, and payload capability.',
    quizId: 'am-q3',
    order: 1,
    xpReward: 35,
  },
  {
    ...
    shortExplanation: 'Why brake force distribution matters in trucks and SUVs.',
    content:
    ...
    keyTakeaway: 'Correct brake bias helps preserve directional stability and stopping confidence.',
    quizId: 'am-q4',
    order: 2,
    xpReward: 35,
  },
  {
    ...
    shortExplanation: 'Why inline-4 architectures are common in reliability-focused designs.',
    content:
    ...
    keyTakeaway: 'Inline-4 layouts align packaging efficiency with long-term serviceability.',
    quizId: 'jp-q1',
    order: 1,
    xpReward: 30,
  },
  {
    ...
    keyTakeaway: 'Variable valvetrain control helps one engine behave efficiently in multiple operating regimes.',
    quizId: 'jp-q2',
    order: 2,
    xpReward: 30,
  },
  {
    ...
    shortExplanation: 'How continuously variable ratios maintain efficient operation.',
    content:
    ...
    keyTakeaway: 'CVTs prioritize smooth ratio adaptation over fixed gear transitions.',
    quizId: 'jp-q3',
    order: 1,
    xpReward: 35,
  },
  {
    ...
    keyTakeaway: 'Hybrid efficiency comes from coordinated control, not just added components.',
    quizId: 'jp-q4',
    order: 2,
    xpReward: 35,
  },
  {
    ...
    shortExplanation: 'Boost, airflow, and transient response in performance systems.',
    content:
    ...
    keyTakeaway: 'Turbo performance is primarily a control and thermal management challenge.',
    quizId: 'eu-q1',
    order: 1,
    xpReward: 35,
  },
  {
    ...
    shortExplanation: 'Fuel delivery timing and atomization under high pressure.',
    content:
    ...
    keyTakeaway: 'DI precision depends on high-pressure control and accurate injection events.',
    quizId: 'eu-q2',
    order: 2,
    xpReward: 35,
  },
  {
    ...
    keyTakeaway: 'DCT performance comes from synchronized clutch and gear preselection control.',
    quizId: 'eu-q3',
    order: 1,
    xpReward: 40,
  },
  {
    ...
    keyTakeaway: 'CAN architecture enables synchronized, distributed vehicle control.',
    quizId: 'eu-q4',
    order: 2,
    xpReward: 40,
  },
